...
> **Need Testnet USDC?** Get some from the [Circle Faucet](https://faucet.circle.com) (select "Arc Testnet").
...
- **Gas-free Payments**: Currently supported on **[Arc Testnet](https://arc.network)**.
